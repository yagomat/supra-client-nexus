...
import { QrCode, Smartphone, Power, PowerOff, MessageSquare, Clock } from "lucide-react";
...
export const WhatsAppBotInterface = () => {
  ...
  const renderQRCode = () => {
    ...
    // Convert QR code text to QR image using a service
    const qrImageUrl = `https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${encodeURIComponent(session.qr_code)}`;
