...
export async function getDashboardStats(): Promise<DashboardStats> {
  ...
  // Os dados de clientes em risco agora vêm do backend (incluídos na função get_dashboard_stats)
  
  return processedData as unknown as DashboardStats;
}

// Função removida - agora a lógica de clientes em risco é executada no backend
// para melhor performance e segurança (evita N+1 queries e exposição de lógica de negócio)
