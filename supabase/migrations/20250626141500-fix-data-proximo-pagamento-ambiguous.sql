...
-- Corrigir erro de referência ambígua na função get_fila_cobranca
...
BEGIN
  ...
  WITH clientes_com_pagamento_atual AS (
    SELECT 
      ...
      -- Calcular a data do próximo pagamento (qualificando explicitamente)
      CASE 
  ...
  ORDER BY cc.prioridade_calc ASC, cc.cliente_nome ASC;
END;
$$;
